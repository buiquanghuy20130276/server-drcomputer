...
public class PaymentController {
    ...
    public ResponseEntity<?> createPayment(@RequestBody PaymentReqDTO req, HttpServletRequest reqa) throws UnsupportedEncodingException {
        ...
        String vnp_IpAddr = Config.getIpAddress(reqa);
